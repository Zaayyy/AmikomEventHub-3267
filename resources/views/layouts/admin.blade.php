    ...
    <aside class="w-64 bg-indigo-900 text-indigo-100 flex flex-col p-6 space-y-8 sticky top-0 h-screen">
        ...
        <nav class="flex-1 space-y-2">
            ...
            <a href="{{ route('admin.partner-registrations.index') }}"
                class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('admin.partner-registrations.*') ? 'bg-indigo-800 text-white' : 'hover:bg-indigo-800' }} rounded-xl font-bold transition">

            <svg class="w-5 h-5 {{ request()->routeIs('admin.partner-registrations.*') ? 'text-indigo-300' : 'text-indigo-400' }}"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24">
...
<a href="{{ route('admin.pengurus.index') }}"
   class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('admin.pengurus.*') ? 'bg-indigo-800 text-white' : 'hover:bg-indigo-800' }} rounded-xl font-bold transition">
    ...
    <svg class="w-5 h-5 {{ request()->routeIs('admin.pengurus.*') ? 'text-indigo-300' : 'text-indigo-400' }}"
         fill="none"
         stroke="currentColor"
         viewBox="0 0 24 24">
    ...
    Kelola Pengurus
            ...
            <!-- Menu Laporan Transaksi (Baru Ditambahkan Sesuai Modul) -->
